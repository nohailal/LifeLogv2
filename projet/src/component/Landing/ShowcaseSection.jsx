...
function ShowcaseSection () {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Track your health progress and keep a daily record of your wellness journey."
    },
    {
      icon: <ListTodo />,
      title: "TO-DO List",
    ...
    },
    {
      icon: <NotebookText />,
      title: "Secret Diary",
      desc: "A private space to document your thoughts, feelings, and special moments securely."
    },
    {
      icon: <Footprints />,
      title: "Your Steps",
      desc: "Monitor and analyze your daily steps and physical activities to stay active and fit."
    },
    {
      icon: <Lock />,
      title: "Privacy",
      desc: "Your data is secure and your privacy is our priority."
    },
