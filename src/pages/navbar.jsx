...
const services = [
  { name: 'Todo list', icon: ChartPieIcon, route: '/todoList' }, 
  { name: 'Journal', icon: CursorArrowRaysIcon ,route:'/journal'},
  { name: 'Blog', icon: FingerPrintIcon ,route:'/blogNavbar'},
];
                ...
                {services.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-auto">
                      <Link to={item.route} className="block font-semibold text-gray-900">
                        {item.name}
