...
function SignIn () {
  return (
      <main className="w-full flex">
          <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex bg-gradient-to-r from-[#FAACA8] to-[#DDD6F3]">
              <div className="relative z-10 w-full max-w-md">
                  <img src={logo} width={150} />
                  <div className=" mt-16 space-y-3">
                      <h3 className="text-black text-3xl font-bold">Start tracking your daily activites</h3>
              ...
              <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                  <div className="">
                      ...
                      <div className="mt-5 space-y-2">
                          ...
                          <p className="">Already have an account? <a href="/login" className="font-medium text-rose-600 hover:text-rose-500">Log in</a></p>
                      </div>
                  </div>
